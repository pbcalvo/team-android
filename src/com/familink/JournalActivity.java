...
public class JournalActivity extends Activity {
	...
	int kid_id, group_id;
	String kid_name;
	Button new_obs_top, new_meal_top, new_nap_top, new_stool_top, add_obs,
			cancel_obs;
	Dialog dialog;
	Button journal;
	Button message;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (observation) {
			...
			for (int o = 0; o < observation_kid.size(); o++) {
				...
				addObs(new Observation(observation_kid.get(o).getDate(),
						observation_kid.get(o).getObservation()));
			}
					...
					builder.setPositiveButton(R.string.string_add,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									EditText editText = (EditText) clickView
											.findViewById(R.id.obs_text);
									WebAPICommunicator communicator = WebAPICommunicator
											.getInstance();
									Observation obs = new Observation(Calendar
											.getInstance(), editText.getText()
											.toString());
		...
		if (meal) {
			...
			for (int o = 0; o < meal_kid.size(); o++) {
				...
				addMeals(new Meal(meal_kid.get(o).getDate(), meal_kid.get(o)
						.getTypeMeal(), meal_kid.get(o).getHowMuchEat(),
						meal_kid.get(o).getMeal()));
					...
					builder.setPositiveButton(R.string.string_add,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									RadioButton breakfast = (RadioButton) clickView
											.findViewById(R.id.breakfast);
									RadioButton snackAM = (RadioButton) clickView
											.findViewById(R.id.snack_am);
									RadioButton lunch = (RadioButton) clickView
											.findViewById(R.id.lunch);
									RadioButton snackPM = (RadioButton) clickView
											.findViewById(R.id.snack_pm);

									if (breakfast.isChecked())
										typeMeal = TypeMeal.BREAKFAST;
									else if (snackAM.isChecked())
										typeMeal = TypeMeal.SNACK_AM;
									else if (lunch.isChecked())
										typeMeal = TypeMeal.LUNCH;
									else if (snackPM.isChecked())
										typeMeal = TypeMeal.SNACK_PM;
									else
										typeMeal = TypeMeal.DINNER;

									RadioButton tasted = (RadioButton) clickView
											.findViewById(R.id.tasted);
									RadioButton something = (RadioButton) clickView
											.findViewById(R.id.something);
									RadioButton half = (RadioButton) clickView
											.findViewById(R.id.half);
									RadioButton almost = (RadioButton) clickView
											.findViewById(R.id.almost);

									if (tasted.isChecked())
										howMuchEat = HowMuchEat.JUST_TASTED_IT;
									else if (something.isChecked())
										howMuchEat = HowMuchEat.SOMETHING;
									else if (half.isChecked())
										howMuchEat = HowMuchEat.HALF;
									else if (almost.isChecked())
										howMuchEat = HowMuchEat.ALMOST_EVERYTHING;
									else
										howMuchEat = HowMuchEat.ALL;

									EditText text = (EditText) clickView
											.findViewById(R.id.editText1);
									specifiedMeal = text.getText().toString();

									Meal meal = new Meal(
											Calendar.getInstance(), typeMeal,
											howMuchEat, specifiedMeal);
		...
		if (nap) {
			...
			for (int o = 0; o < nap_kid.size(); o++) {
				...
				// addObs(new Observation(observation_kid.get(o).getDate(),
				// observation_kid.get(o).getObservation()));
				addNaps(new Nap(nap_kid.get(o).getStartTime(), nap_kid.get(o)
						.getEndTime()));
			}
				...
				public void onClick(View v) {
					...
					builder.setPositiveButton(R.string.string_add,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
										int which) {
									TimePicker picker1 = (TimePicker) clickView
											.findViewById(R.id.timePicker1);
									TimePicker picker2 = (TimePicker) clickView
											.findViewById(R.id.timePicker2);

									Calendar startTime = Calendar.getInstance();
									startTime.set(Calendar.HOUR_OF_DAY,
											picker1.getCurrentHour());
		...
		if (stool) {
			...
			for (int o = 0; o < stool_kid.size(); o++) {
				...
				// addObs(new Observation(observation_kid.get(o).getDate(),
				// observation_kid.get(o).getObservation()));
				addStools(new Stool(stool_kid.get(o).getDate(), stool_kid
						.get(o).getStoolCarasteristic(), stool_kid.get(o)
						.getComments()));

			}

			// addStools(new Stool(Calendar.getInstance(),
			// StoolCharacteristics.NORMAL, "Sin olor"));
				...
				public void onClick(View v) {
					...
					builder.setPositiveButton(R.string.string_add,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
										int which) {
									TimePicker picker = (TimePicker) clickView
											.findViewById(R.id.timePicker1);
									...
									RadioButton normal = (RadioButton) clickView
											.findViewById(R.id.normal);
									RadioButton solid = (RadioButton) clickView
											.findViewById(R.id.solid);
									RadioButton soft = (RadioButton) clickView
											.findViewById(R.id.soft);
									RadioButton fluid = (RadioButton) clickView
											.findViewById(R.id.fluid);
									RadioButton pee = (RadioButton) clickView
											.findViewById(R.id.pee);
									RadioButton dry = (RadioButton) clickView
											.findViewById(R.id.dry);

									StoolCharacteristics stoolCharacteristic;

									if (normal.isChecked())
										stoolCharacteristic = StoolCharacteristics.NORMAL;
									else if (solid.isChecked())
										stoolCharacteristic = StoolCharacteristics.SOLID;
									else if (soft.isChecked())
										stoolCharacteristic = StoolCharacteristics.SOFT;
									else if (fluid.isChecked())
										stoolCharacteristic = StoolCharacteristics.FLUID;
									else if (pee.isChecked())
										stoolCharacteristic = StoolCharacteristics.PEE;
									else if (dry.isChecked())
										stoolCharacteristic = StoolCharacteristics.DRY;
									else
										stoolCharacteristic = StoolCharacteristics.OTHER;

									EditText text = (EditText) clickView
											.findViewById(R.id.editText1);

									Stool stool = new Stool(date,
											stoolCharacteristic, text.getText()
													.toString());
									WebAPICommunicator communicator = WebAPICommunicator
											.getInstance();
	...
	public void addObs(Observation obs) {
		...
		date_text.setText(obs.getDate().get(Calendar.HOUR_OF_DAY) + ":"
				+ obs.getDate().get(Calendar.MINUTE) + ", today");
	...
	public void addMeals(Meal meal) {
		...
		if (meal.getTypeMeal() == TypeMeal.BREAKFAST)
			type = this.getString(R.string.string_breakfast);
		else if (meal.getTypeMeal() == TypeMeal.SNACK_AM)
			type = this.getString(R.string.string_snackam);
		else if (meal.getTypeMeal() == TypeMeal.LUNCH)
			type = this.getString(R.string.string_lunch);
		else if (meal.getTypeMeal() == TypeMeal.SNACK_PM)
			type = this.getString(R.string.string_snackpm);
		else
			type = this.getString(R.string.string_dinner);

		if (meal.getHowMuchEat() == HowMuchEat.JUST_TASTED_IT)
			howMuch = this.getString(R.string.string_justtasted);
		else if (meal.getHowMuchEat() == HowMuchEat.SOMETHING)
			howMuch = this.getString(R.string.string_something);
		else if (meal.getHowMuchEat() == HowMuchEat.HALF)
			howMuch = this.getString(R.string.string_half);
		else if (meal.getHowMuchEat() == HowMuchEat.ALMOST_EVERYTHING)
			howMuch = this.getString(R.string.string_alev);
		else
			howMuch = this.getString(R.string.string_all);
	...
	public void addNaps(Nap nap) {
		...
		content_text.setText(JournalActivity.this.getResources().getString(
				R.string.nap_from)
				+ " "
				+ nap.getStartTime().get(Calendar.HOUR_OF_DAY)
				+ ":"
	...
	public void addStools(Stool stool) {
		...
		if (stool.getStoolCarasteristic() == StoolCharacteristics.NORMAL)
			characteristic = this.getString(R.string.string_normal);
		else if (stool.getStoolCarasteristic() == StoolCharacteristics.SOLID)
			characteristic = this.getString(R.string.string_solid);
		else if (stool.getStoolCarasteristic() == StoolCharacteristics.SOFT)
			characteristic = this.getString(R.string.string_soft);
		else if (stool.getStoolCarasteristic() == StoolCharacteristics.FLUID)
			characteristic = this.getString(R.string.string_fluid);
		else if (stool.getStoolCarasteristic() == StoolCharacteristics.PEE)
			characteristic = this.getString(R.string.string_pee);
		else if (stool.getStoolCarasteristic() == StoolCharacteristics.DRY)
			characteristic = this.getString(R.string.string_dry);
		else
			characteristic = this.getString(R.string.string_other);
		...
		content_text
				.setText(stool.getDate().get(Calendar.HOUR_OF_DAY) + ":"
						+ stool.getDate().get(Calendar.MINUTE) + " - "
						+ characteristic);
